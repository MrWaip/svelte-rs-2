...
pub mod walk {
    ...
    pub fn walk_html_attribute<'a, V: TemplateVisitor<'a>>(
        ...
        match &it.value {
            crate::ast::AttributeValue::String(it) => visitor.visit_string_attribute_value(*it),
            crate::ast::AttributeValue::Expression(it) => {
                visitor.visit_expression_attribute_value(it)
            }
            crate::ast::AttributeValue::Boolean => visitor.visit_boolean_attribute_value(),
            crate::ast::AttributeValue::Concatenation(it) => {
