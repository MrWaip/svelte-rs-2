...
export default function App($$anchor) {
	...
	$.async(node, [], [() => delay($.get(x))], (node, $$condition) => {
	...
	$.async(node_1, [], [() => delay_list($.get(x))], (node_1, $$collection) => {
	...
	$.async(node_2, [], [() => delay($.get(x))], (node_2, $$key) => {
	...
	$.async(node_3, [], [], (node_3) => {
		$.await(node_3, () => delay($.get(x)), null, ($$anchor, value) => {
			var p_3 = root_1();
