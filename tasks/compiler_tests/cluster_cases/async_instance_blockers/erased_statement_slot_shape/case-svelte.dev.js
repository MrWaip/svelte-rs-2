...
export default function App($$anchor, $$props) {
	...
	var loaded;
	var $$promises = $.run([async () => loaded = await $.async_derived(async () => (await $.track_reactivity_loss($.get(gate)))(), "loaded", "(unknown):3:14"), () => void $.inspect(() => [$.get(loaded)], (...$$args) => console.log(...$$args), true)]);
