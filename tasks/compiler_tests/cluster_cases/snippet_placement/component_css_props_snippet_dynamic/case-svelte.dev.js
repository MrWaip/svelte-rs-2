...
var root_1 = $.add_locations($.from_html(`<svelte-css-wrapper style="display: contents"><!></svelte-css-wrapper>`, 1), App[$.FILENAME], [[5, 0]]);
export default function App($$anchor, $$props) {
	...
	var node = $.first_child(fragment);
	{
		...
		$.component(node.lastChild, () => $$props.Comp, ($$anchor, $$component) => {
			$$component($$anchor, {
				element,
				$$slots: { element: true }
			});
