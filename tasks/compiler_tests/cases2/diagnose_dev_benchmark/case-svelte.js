...
export default function App($$anchor, $$props) {
	...
	const metricSummary = ($$anchor, $$arg0) => {
		...
		$.each(node_2, 17, () => $.get(values), $.index, ($$anchor, value, index) => {
			var span_1 = root_3();
	...
	let title = $.prop($$props, "title", 3, "Default Title"), count = $.prop($$props, "count", 3, 0), items = $.prop($$props, "items", 19, () => []), config = $.prop($$props, "config", 27, () => $.proxy({})), multiplier = $.prop($$props, "multiplier", 3, 2), visible = $.prop($$props, "visible", 11, false), rest = $.rest_props($$props, rest_excludes);
	let state = $.state("");
	let counter = $.state(0);
	let rawData = {
		x: 1,
