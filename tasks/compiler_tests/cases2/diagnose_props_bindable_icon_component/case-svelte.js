...
var root = $.from_html(`<div class="ui-input-icon svelte-nbptzh"><!></div>`);
var root_1 = $.from_html(`<div class="ui-input-wrapper svelte-nbptzh"><!> <input class="ui-input svelte-nbptzh"/></div>`);
