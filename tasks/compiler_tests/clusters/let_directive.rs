...
compiler_case!(declaration_array_rest, "legacy/let_directive/declaration/array_rest");
compiler_case!(declaration_array_rest_nested, "legacy/let_directive/declaration/array_rest_nested");
compiler_case!(declaration_computed_key, "legacy/let_directive/declaration/computed_key");
compiler_case!(declaration_default_intermediate_array, "legacy/let_directive/declaration/default_intermediate_array");
compiler_case!(declaration_default_intermediate_object, "legacy/let_directive/declaration/default_intermediate_object");
compiler_case!(declaration_default_leaf_array, "legacy/let_directive/declaration/default_leaf_array");
