...
compiler_case!(concat_call, "attribute/memo/concat_call");
compiler_case!(
...
compiler_case!(expression_call, "attribute/memo/expression_call");
compiler_case!(literal_root_call, "attribute/memo/literal_root_call");
compiler_case!(
