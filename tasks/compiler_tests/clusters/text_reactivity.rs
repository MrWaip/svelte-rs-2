...
compiler_case!(derived_nonreactive_dep, "text_reactivity/derived_nonreactive_dep");
compiler_case!(
...
compiler_case!(derived_chain_nonreactive, "text_reactivity/derived_chain_nonreactive");
