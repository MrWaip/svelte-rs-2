...
- Svelte reference:
  - `original/compiler/phases/1-parse/read/script.js` — attribute parsing, `context` field
  - `original/compiler/phases/1-parse/state/element.js` — `root.module` vs `root.instance` placement
  - `original/compiler/phases/2-analyze/index.js` — scope hierarchy (module → instance → template), `ast_type` assignment
  - `original/compiler/phases/2-analyze/visitors/ExportNamedDeclaration.js` — export validation by `ast_type`
  - `original/compiler/phases/2-analyze/visitors/ExportDefaultDeclaration.js` — `module_illegal_default_export`
  - `original/compiler/phases/3-transform/client/transform-client.js` — module AST walk, body merge (lines 502-514)
  - `original/compiler/phases/3-transform/client/visitors/ExportNamedDeclaration.js` — pass-through for module exports
  - `original/compiler/phases/3-transform/client/visitors/Program.js` — `is_instance` branching
- Our code:
