...
- `original/compiler/phases/2-analyze/index.js:451-515` — auto-detect + maybe_runes resolution.
- `original/compiler/phases/3-transform/client/visitors/shared/utils.js:446-454` — `runes || maybe_runes` consumer in `build_expression`.
- `original/compiler/phases/scope.js:1033-1041, 1433-1469` — top-level await as runes signal, shadowing.
