...
- Reference docs: `original/docs/03-template-syntax/16-animate.md`
- Reference parse classification: `original/compiler/phases/1-parse/state/element.js`
- Reference validation: `original/compiler/phases/2-analyze/visitors/shared/element.js`
- Reference client transform: `original/compiler/phases/3-transform/client/visitors/EachBlock.js`
