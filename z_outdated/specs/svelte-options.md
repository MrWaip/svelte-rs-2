...
- Reference docs: `original/docs/07-misc/07-v5-migration-guide.md`
- Reference parser: `original/compiler/phases/1-parse/read/options.js`
- Reference parser extraction: `original/compiler/phases/1-parse/index.js`
- Reference analyze warnings: `original/compiler/phases/2-analyze/index.js`
