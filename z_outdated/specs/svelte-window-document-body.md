...
- `original/docs/05-special-elements/02-svelte-window.md`
- `original/docs/05-special-elements/03-svelte-document.md`
- `original/docs/05-special-elements/04-svelte-body.md`
- `original/compiler/phases/1-parse/state/element.js`
- `original/compiler/phases/2-analyze/visitors/SvelteWindow.js`
- `original/compiler/phases/2-analyze/visitors/SvelteDocument.js`
- `original/compiler/phases/2-analyze/visitors/SvelteBody.js`
- `original/compiler/phases/2-analyze/visitors/shared/special-element.js`
- `original/compiler/phases/2-analyze/visitors/BindDirective.js`
- `original/compiler/phases/3-transform/client/visitors/SvelteWindow.js`
- `original/compiler/phases/3-transform/client/visitors/SvelteDocument.js`
- `original/compiler/phases/3-transform/client/visitors/SvelteBody.js`
- `original/compiler/phases/3-transform/client/visitors/shared/special_element.js`
