...
## Reference
### Svelte
- `original/docs/99-legacy/31-legacy-svelte-self.md`
- `original/compiler/phases/1-parse/state/element.js`
- `original/compiler/phases/2-analyze/visitors/SvelteSelf.js`
- `original/compiler/phases/2-analyze/visitors/shared/component.js`
- `original/compiler/phases/3-transform/client/visitors/SvelteSelf.js`
