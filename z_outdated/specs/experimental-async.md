...
- `original/compiler/phases/nodes.js` — `ExpressionMetadata`: `has_await`, `blockers()`, `is_async()`
- `original/compiler/phases/2-analyze/index.js` — blocker assignment, `async_deriveds` set, `pickled_awaits`
- `original/compiler/phases/2-analyze/visitors/CallExpression.js` — `$derived` async detection
- `original/compiler/phases/3-transform/client/visitors/shared/utils.js` — `Memoizer` (async/sync tracking, `blockers()`, `async_values()`, `async_ids()`)
- `original/compiler/phases/3-transform/client/visitors/javascript.js` — sync/async segment splitting, `$.run()` generation
- `original/compiler/phases/3-transform/client/visitors/IfBlock.js`
- `original/compiler/phases/3-transform/client/visitors/EachBlock.js`
- `original/compiler/phases/3-transform/client/visitors/HtmlTag.js`
- `original/compiler/phases/3-transform/client/visitors/KeyBlock.js`
- `original/compiler/phases/3-transform/client/visitors/AwaitBlock.js`
- `original/compiler/phases/3-transform/client/visitors/SvelteElement.js` — `$.async()` wrapping for dynamic tag
- `original/compiler/phases/3-transform/client/visitors/ConstTag.js` — `$.run()` async const accumulation, blocker propagation
- `original/compiler/phases/3-transform/client/visitors/VariableDeclaration.js` — `$.async_derived()` for async `$derived`
- `original/compiler/phases/3-transform/client/visitors/RenderTag.js` — `Memoizer` blockers/async for render tags
- `original/compiler/phases/3-transform/client/visitors/TitleElement.js` — `Memoizer` blockers/async for title
- `original/compiler/phases/3-transform/client/visitors/SvelteBoundary.js` — async-aware const tag + snippet handling
- `original/compiler/phases/3-transform/client/visitors/BindDirective.js`
- `original/compiler/phases/3-transform/client/visitors/UseDirective.js`
- `original/compiler/phases/3-transform/client/visitors/AttachTag.js`
- `original/compiler/phases/3-transform/client/visitors/TransitionDirective.js`
- `original/compiler/phases/3-transform/client/visitors/AnimateDirective.js`
- `original/compiler/phases/3-transform/client/visitors/BlockStatement.js` — async tracing (`$.trace` with await)
