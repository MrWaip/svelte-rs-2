...
- Reference docs: `original/docs/03-template-syntax/14-transition.md`
- Reference docs: `original/docs/03-template-syntax/15-in-and-out.md`
- Reference parse classification: `original/compiler/phases/1-parse/state/element.js`
- Reference transition analyze visitor: `original/compiler/phases/2-analyze/visitors/TransitionDirective.js`
- Reference element validation: `original/compiler/phases/2-analyze/visitors/shared/element.js`
- Reference client transform: `original/compiler/phases/3-transform/client/visitors/TransitionDirective.js`
- Reference if-block transition note: `original/compiler/phases/3-transform/client/visitors/IfBlock.js`
