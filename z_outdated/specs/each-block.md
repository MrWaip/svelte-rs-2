...
- Reference docs:
  - `original/docs/03-template-syntax/03-each.md`
- Reference compiler:
  - `original/compiler/phases/1-parse/state/tag.js`
  - `original/compiler/phases/2-analyze/visitors/EachBlock.js`
  - `original/compiler/phases/2-analyze/visitors/shared/utils.js`
