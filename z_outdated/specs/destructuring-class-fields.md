...
- `original/docs/02-runes/02-$state.md` — destructuring caveat, class-field forms, constructor assignment
- `original/docs/02-runes/03-$derived.md` — destructured `$derived` semantics and class-field support
- `original/compiler/phases/3-transform/client/visitors/VariableDeclaration.js` — destructured `$state` / `$derived` lowering
- `original/compiler/phases/3-transform/client/visitors/ClassBody.js` — class-field lowering
- `original/compiler/utils/ast.js` — `extract_paths`
