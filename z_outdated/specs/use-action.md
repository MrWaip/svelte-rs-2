...
- `original/docs/03-template-syntax/13-use.md`
- `original/docs/05-special-elements/04-svelte-body.md`
- `original/docs/07-misc/01-best-practices.md`
- `original/compiler/phases/1-parse/state/element.js`
- `original/compiler/phases/2-analyze/visitors/UseDirective.js`
...
- `original/compiler/types/template.d.ts`
