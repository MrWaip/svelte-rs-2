...
- Reference docs: `original/docs/07-misc/04-custom-elements.md`
- Reference docs: `original/docs/05-special-elements/07-svelte-options.md`
- Reference docs: `original/docs/02-runes/08-$host.md`
- Reference parser: `original/compiler/phases/1-parse/read/options.js`
- Reference compile-option merge: `original/compiler/index.js`
- Reference analyze: `original/compiler/phases/2-analyze/index.js`
- Reference analyze warning: `original/compiler/phases/2-analyze/visitors/VariableDeclarator.js`
- Reference client transform: `original/compiler/phases/3-transform/client/transform-client.js`
