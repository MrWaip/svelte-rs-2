...
- Reference docs: `original/docs/03-template-syntax/11-@debug.md`
- Reference parse: `original/compiler/phases/1-parse/state/tag.js`
- Reference analyze: `original/compiler/phases/2-analyze/visitors/DebugTag.js`
- Reference client transform: `original/compiler/phases/3-transform/client/visitors/DebugTag.js`
- Reference server transform: `original/compiler/phases/3-transform/server/visitors/DebugTag.js`
