...
- Reference docs:
  - `original/docs/02-runes/04-$effect.md`
- Reference compiler:
  - `original/compiler/phases/2-analyze/visitors/CallExpression.js`
  - `original/compiler/phases/3-transform/client/visitors/CallExpression.js`
  - `original/compiler/phases/3-transform/server/visitors/CallExpression.js`
  - `original/compiler/phases/3-transform/server/visitors/ExpressionStatement.js`
