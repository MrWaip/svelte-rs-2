...
- Reference docs: `original/docs/05-special-elements/01-svelte-boundary.md`
- Reference parser tag registration: `original/compiler/phases/1-parse/state/element.js`
- Reference analyze validation: `original/compiler/phases/2-analyze/visitors/SvelteBoundary.js`
- Reference identifier handling for async boundary snippets: `original/compiler/phases/2-analyze/visitors/Identifier.js`
- Reference client transform: `original/compiler/phases/3-transform/client/visitors/SvelteBoundary.js`
- Reference server transform: `original/compiler/phases/3-transform/server/visitors/SvelteBoundary.js`
