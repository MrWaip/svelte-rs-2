...
- `original/compiler/validate-options.js` (option validation)
- `original/compiler/phases/1-parse/state/element.js` (Comment AST node creation, leadingComments for script/style)
- `original/compiler/phases/3-transform/utils.js` `clean_nodes` (filter when `!preserve_comments`)
- `original/compiler/phases/3-transform/client/visitors/Comment.js` (push_comment(data))
- `original/compiler/phases/3-transform/client/visitors/Fragment.js` (passes preserveComments to clean_nodes)
- `original/compiler/phases/3-transform/client/visitors/RegularElement.js` (passes preserveComments to clean_nodes for children)
- `original/compiler/phases/3-transform/client/transform-template/template.js` `push_comment` (emits `<!--data-->` in HTML, `[\`// data\`]` in tree)
