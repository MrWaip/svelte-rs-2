...
4. **Quality check**: verify the plan against **Pre-commit self-check** in CLAUDE.md — correct layer, no boundary violations, proper visitor usage, SymbolId, edge cases

**Present the plan and wait for approval before proceeding.**

---

## EXECUTE PHASE (steps 4–7)
