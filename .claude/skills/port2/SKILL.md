---
name: port2
description: Port one approved slice of a Svelte compiler feature from spec to the Rust implementation. Use when a feature already has a spec and Claude should implement only the next bounded slice, not the whole feature, while keeping strict parser/analyze/codegen boundaries.
---
