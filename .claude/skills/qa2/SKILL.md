---
name: qa2
description: Review recent implementation work for material, defensible issues in correctness, architecture, regression risk, and missing test coverage. Use after port2, fix-test, improve, or other code changes when Claude should act like a strict reviewer and avoid low-value style or comment nitpicks.
---
