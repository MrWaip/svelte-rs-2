...
impl DiagnosticKind {
    pub fn code(&self) -> &'static str {
        match self {
            ...
            Self::DeclarationTagNoLegacyMode => "declaration_tag_no_legacy_mode",
    ...
    pub fn message(&self) -> String {
        match self {
            ...
            Self::DeclarationTagInvalidType => "Declaration tags must be `let` or `const` declarations".into(),
            Self::DeclarationTagNoLegacyMode => "Declaration tags cannot be used in legacy mode".into(),
