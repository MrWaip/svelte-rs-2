...
pub use types::data::{
    ...
    FragmentFactsEntry, IgnoreData, ImageNaturalSizeKind, JsAst, MediaBindKind, NamespaceKind,
    OptimizedRuneSemantics, OutputPlanData, ParentKind, ParentRef, PickledAwaitOffsets,
    PropDeclarationKind, PropDeclarationSemantics, PropDefaultLowering, PropLoweringMode,
    PropReferenceSemantics, PropsObjectPropertySemantics, ProxyStateInits, ReactivitySemantics,
