...
pub use types::data::{
    ...
    FragmentFacts, FragmentFactsEntry, FragmentKey, FragmentKeyExt, IgnoreData,
    ImageNaturalSizeKind, MediaBindKind, NamespaceKind, OptimizedRuneSemantics, OutputPlanData,
    ParentKind, ParentRef, ParserResult, PickledAwaitOffsets, PropDeclarationKind,
